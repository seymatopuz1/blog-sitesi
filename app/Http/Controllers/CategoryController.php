...
class CategoryController extends Controller
{
    ...
    public function update(Request $request, Category $category)
    {
        ...
        return redirect(route('categories.index'))->with('status', 'Kategori Başarılı bir şekilde editlendi');
    ...
    public function destroy(Category $category)
    {
        ...
        return redirect()->back()->with('status', 'Kategori Başarıyla Silinmiştir ');
    }
}
