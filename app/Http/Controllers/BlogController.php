...
class BlogController extends Controller
{
    ...
    {
        //giriş yapmadan paylaşım yapmasını engelliyoruz
    ...
    public function store(Request $request ){
      ...
      if ( Post::latest()->first() !== null){
          $postId = Post::latest()->first()->id + 1;// aynı isimde fazladan post olursa postun idsinden bulunur
      } else{
          $postId = 1;
      }
      ...
      return redirect()->back()->with('status','Post başarıyla eklendi');
    ...
    public function update(Request $request, Post $post){
        ...
        return redirect()->back()->with('status','Düzenlenen Post Başarıyla eklendi');
    ...
    // Using Route Model Binding => Route bağlanması
    ...
    public function destroy(Post $post){
       $post->delete();
        return redirect()->back()->with('status','Post Başarıyla Silindi');
