...
@section('main')
    ...
    <main class="container">
        <h2 class="header-title">Paylaşılan Bütün Postlar</h2>
        ...
        <section class="cards-blog latest-blog">
            @forelse($posts as $post )<!--DB ten güncel olarak paylaşımı ne zaman yaptığını sağlıyor-->
                ...
                @empty
                <p>Üzgünüz aradığınız sonuç bulunamadı</p>
            @endforelse
